...
//			텍스트암호화
			...
			//결과를 합치는 작업
			//-결과물의 크기 = by의 길이 + initialblock의 길이 + encryptTextBlcok
		...
		@Test
		public void aes256decrypt() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
			String origin = "x1QIQyBsHbQUSIF+sxM6hPknBFWY3fN690NFKNUNndb0KdKKka1ecPYxFK3926+AcmemlQ=="; 
			String offset = "kh";
			//복원 객체 생성
			Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
